...
<html lang="en">
    ...
    <body class="register-bg">
        ...
        {{-- CONTENT --}}
        <div
            class="container d-flex justify-content-center min-vh-100 py-5 my-5 align-items-md-center"
        >
                ...
                <div class="card p-2 mb-3 border-secondary shadow-sm">
                    <div class="card-body">
                        @if ($customer->c_foto_profile)
                            <img
                                src="{{ asset("uploads/customers/" . $customer->c_foto_profile) }}"
                                alt="Foto Profile"
                        ...
                        <form
                            action="{{ route("edit.profile", $customer->c_id) }}"
                            method="POST"
...
{{ old("alamat", $customer->c_alamat) }}</textarea
                            ...
                            <div class="d-grid">
                                <button
                                    type="submit"
                                    class="btn btn-dark border-secondary rounded-pill mb-2"
                                >
                                    Save
                                </button>
                            </div>
